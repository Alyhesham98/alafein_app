...
class EventOrganizerMap extends StatefulWidget {
  const EventOrganizerMap({
    super.key,
  });

  @override
  State<EventOrganizerMap> createState() => _EventOrganizerMapState();
}

class _EventOrganizerMapState extends State<EventOrganizerMap> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        key: const ValueKey('EventOrganizerMap'),
