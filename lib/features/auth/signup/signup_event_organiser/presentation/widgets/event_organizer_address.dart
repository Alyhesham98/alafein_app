...
class EventOrganizerAddress extends StatefulWidget {
  const EventOrganizerAddress({
    super.key,
  });

  @override
  State<EventOrganizerAddress> createState() => _EventOrganizerAddressState();
}

class _EventOrganizerAddressState extends State<EventOrganizerAddress> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        key: const ValueKey('EventOrganizerAddress'),
