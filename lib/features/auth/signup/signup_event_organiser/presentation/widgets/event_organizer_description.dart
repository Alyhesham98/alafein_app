...
class EventOrganizerDescription extends StatefulWidget {
  const EventOrganizerDescription({
    super.key,
  });

  @override
  State<EventOrganizerDescription> createState() =>
      _EventOrganizerDescriptionState();
}

class _EventOrganizerDescriptionState extends State<EventOrganizerDescription> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        key: const ValueKey('EventOrganizerDescription'),
