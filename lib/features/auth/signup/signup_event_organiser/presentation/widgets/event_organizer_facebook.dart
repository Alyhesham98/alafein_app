...
class EventOrganizerFacebook extends StatefulWidget {
  const EventOrganizerFacebook({
    super.key,
  });

  @override
  State<EventOrganizerFacebook> createState() => _EventOrganizerFacebookState();
}

class _EventOrganizerFacebookState extends State<EventOrganizerFacebook> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: TextFormField(
        ...
        key: const ValueKey('EventOrganizerFacebook'),
