...
class BranchNameField extends StatefulWidget {
  const BranchNameField({
    super.key,
  });

  @override
  State<BranchNameField> createState() => _BranchNameFieldState();
}

class _BranchNameFieldState extends State<BranchNameField> {
